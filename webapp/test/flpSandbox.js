		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Overview App Inventory",
									"targetURL": "#comsampleovappinv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsampleovappinv-display": {
								"semanticObject": "comsampleovappinv",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.ovappinv",
									"url": sap.ui.require.toUrl("com/sample/ovappinv")
								}
							}
						}
					}
